...
class Razas_dogs(db.Model):
    ...
    consejos = db.Column(db.String(250),unique=True, nullable=False)
    origen = db.Column(db.String(250),unique=True, nullable=False)
    salud = db.Column(db.String(250),unique=True, nullable=False)
    ejercicio = db.Column(db.String(250),unique=True, nullable=False)
